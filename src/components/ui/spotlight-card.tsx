  ...
  const getInlineStyles = () => {
    const baseStyles: Record<string, any> = {
      ...
      backgroundImage: `radial-gradient(
        ...
        calc(var(--x, 0) * 1px)
        calc(var(--y, 0) * 1px),
        hsla(var(--hue, 220), 100%, 60%, 0.35), transparent
      )`,
  ...
  return (
    <>
      ...
      <div
        ...
        `}
      >
        {/* decorative overlay - kept behind content */}
        <div ref={innerRef} data-glow className="absolute inset-0 z-0 pointer-events-none" />
