  ...
  return (
    <div className="page-container max-w-2xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-muted-foreground mb-8">Contribute a job description to earn vElixir</p>
      </motion.div>
      ...
      <AnimatePresence mode="wait">
        {success ? (
          ...
          >
            ...
            <p className="text-muted-foreground mb-2">You earned <span className="text-primary font-bold">+25 vElixir</span></p>
